                ...
                <div class="col-12 col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="{{ route('equipment.create') }}" class="btn btn-success btn-sm float-end ms-2">
                                <i class="bi bi-plus"></i> Add
                            </a>
                            <form action="{{ route('equipment.importExcel') }}" method="POST" enctype="multipart/form-data" class="d-inline">
                                @csrf
