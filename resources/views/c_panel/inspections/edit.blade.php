                            ...
                            <div class="card-body">
                                <form action="{{ route('indicator.update', $indicator->id) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="equipment_id" class="form-control @error('equipment_id') is-invalid @enderror" name="equipment_id" required>
                                            <option value="">Select Equipment</option>
                                            @foreach($equipments as $equipment)
                                                <option value="{{ $equipment->id }}" {{ old('equipment_id', $indicator->equipment_id) == $equipment->id ? 'selected' : '' }}>
                                                    {{ $equipment->name }}
                                                </option>
                                            @endforeach
                                        </select>
